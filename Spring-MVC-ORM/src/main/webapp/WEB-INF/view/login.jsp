		...
		<div class="card">
			...
			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
				...
				<li class="nav-item text-center"><a class="nav-link btr"
					id="pills-profile-tab" data-toggle="pill" href="addUser" role="tab"
					aria-controls="pills-profile" aria-selected="false">Signup</a></li>
					...
					<f:form method="POST" modelAttribute="login" action="login">
						<div class="form px-4 pt-5">
							...
							<f:input type="email" path="email" class="form-control"
								placeholder="Email Id.." /> <f:input type="text"
								path="password" class="form-control" placeholder="Password" />

							<button class="btn btn-dark btn-block" name="submit" value="login">Login</button>
				...
				<div class="tab-pane fade" id="pills-profile" role="tabpanel"
					...
					<div class="form px-4">
						...
						<input type="text" name="" class="form-control"
							...
							type="text" name="" class="form-control" placeholder="Password">
